...
func (_m *MockEnvironment) GetEnvironment(ctx context.Context) (*Config, error) {
	ret := _m.Called(ctx)
	...
	if rf, ok := ret.Get(0).(func(context.Context) *Config); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Config)
...
func (_m *MockEnvironment) GetEnvironmentFromFile(ctx context.Context, fileName string) (*Config, error) {
	...
	var r0 *Config
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*Config, error)); ok {
		return rf(ctx, fileName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *Config); ok {
		r0 = rf(ctx, fileName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Config)
